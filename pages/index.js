      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          <Link href="/manual">
            ...
            <h2><Icon icon={ic_fact_check_outline} size={54}/> 사용법 </h2>
          ...
          <Link href="/camera">
            <a className={styles.card}>
            <h2><Icon icon={ic_qr_code_scanner} size={54}/> 확인하기 </h2>
          ...
          <Link href="/camera">
            <a className={styles.card}>
            <h2><Icon icon={ic_grade_outline} size={54}/> 즐겨찾기 </h2>
          ...
          <Link href="/camera">
            <a className={styles.card}>
            <h2><Icon icon={ic_feedback_outline} size={54}/> 문의하기 </h2>
            <p>촬영을 통해 몸 건강상태를 확인해 보세요!</p>
          </a>
          </Link>
